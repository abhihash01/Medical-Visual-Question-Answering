...
def eval_model(args):
    ...
    if args.mm_projector is None:
        ...
        if "BiomedCLIP" in model_name or "biomed_clip" in model_name:
            ...
            model = LlavaMistralForCausalLM.from_pretrained(model_name, use_cache=True).cuda()
            ...
            model = LlavaMistralForCausalLM.from_pretrained(model_name, torch_dtype=torch.float16, use_cache=True).cuda()
